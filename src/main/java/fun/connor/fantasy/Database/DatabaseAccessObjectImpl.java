...
public class DatabaseAccessObjectImpl implements DatabaseAccessObject {
    ...
    /**
     * This is the same as {@link DatabaseAccessObjectImpl#save(League)} except it takes a Team.
    ...
    /**
     * This is the same as {@link DatabaseAccessObjectImpl#save(League)} except it takes an Athlete.
